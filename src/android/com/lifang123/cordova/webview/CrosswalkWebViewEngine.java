...
public class CrosswalkWebViewEngine extends XWalkWebViewEngine {
    public static final String TAG = "CrosswalkWebViewEngine";
     ...
     */
    public CrosswalkWebViewEngine(Context context, CordovaPreferences preferences) {
